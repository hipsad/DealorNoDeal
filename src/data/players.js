...
export const PLAYERS = [
  // ─── POINT GUARDS (active) ───────────────────────────────────────────────
  { id: 9,  name: 'Stephen Curry',           position: 'PG', value: 26.4, active: true,  era: '2010s' },
  { id: 10, name: 'Chris Paul',              position: 'PG', value: 9.0,  active: true,  era: '2010s' },
  { id: 12, name: 'Damian Lillard',          position: 'PG', value: 24.3, active: true,  era: '2010s' },
  { id: 13, name: 'Kyrie Irving',            position: 'PG', value: 23.4, active: true,  era: '2010s' },
  { id: 14, name: 'Trae Young',              position: 'PG', value: 23.2, active: true,  era: '2020s' },
  { id: 15, name: 'Luka Dončić',             position: 'PG', value: 28.0, active: true,  era: '2020s' },
  { id: 16, name: 'Ja Morant',               position: 'PG', value: 20.1, active: true,  era: '2020s' },
  { id: 17, name: "De'Aaron Fox",            position: 'PG', value: 26.6, active: true,  era: '2020s' },
  { id: 18, name: 'Shai Gilgeous-Alexander', position: 'PG', value: 32.7, active: true,  era: '2020s' },
  { id: 87, name: 'Fred VanVleet',           position: 'PG', value: 10.8, active: true,  era: '2020s' },
  { id: 88, name: 'Tyrese Haliburton',       position: 'PG', value: 20.1, active: true,  era: '2020s' },
  { id: 89, name: 'Cade Cunningham',         position: 'PG', value: 24.8, active: true,  era: '2020s' },
  { id: 90, name: 'Jalen Brunson',           position: 'PG', value: 26.1, active: true,  era: '2020s' },
  { id: 91, name: 'LaMelo Ball',             position: 'PG', value: 30.2, active: true,  era: '2020s' },
  { id: 127, name: 'Tyrese Maxey',           position: 'PG', value: 25.9, active: true,  era: '2020s' },
  { id: 128, name: 'Darius Garland',         position: 'PG', value: 20.6, active: true,  era: '2020s' },
  { id: 129, name: 'Immanuel Quickley',      position: 'PG', value: 17.2, active: true,  era: '2020s' },
  { id: 130, name: 'Josh Giddey',            position: 'PG', value: 14.8, active: true,  era: '2020s' },
  { id: 131, name: 'Scoot Henderson',        position: 'PG', value: 14.2, active: true,  era: '2020s' },
  ...
  { id: 29, name: 'Devin Booker',            position: 'SG', value: 25.4, active: true,  era: '2020s' },
  { id: 30, name: 'Donovan Mitchell',        position: 'SG', value: 24.0, active: true,  era: '2020s' },
  { id: 31, name: 'Zach LaVine',             position: 'SG', value: 23.2, active: true,  era: '2020s' },
  { id: 32, name: 'Bradley Beal',            position: 'SG', value: 17.0, active: true,  era: '2020s' },
  { id: 94, name: 'Tyler Herro',             position: 'SG', value: 23.6, active: true,  era: '2020s' },
  { id: 95, name: 'Jalen Green',             position: 'SG', value: 22.8, active: true,  era: '2020s' },
  { id: 96, name: 'Anfernee Simons',         position: 'SG', value: 20.5, active: true,  era: '2020s' },
  { id: 97, name: 'Desmond Bane',            position: 'SG', value: 22.9, active: true,  era: '2020s' },
  { id: 98, name: 'Jordan Poole',            position: 'SG', value: 17.0, active: true,  era: '2020s' },
  { id: 99, name: 'Cam Thomas',              position: 'SG', value: 22.1, active: true,  era: '2020s' },
  { id: 100, name: 'Anthony Edwards',        position: 'SG', value: 27.0, active: true,  era: '2020s' },
  { id: 133, name: 'Jalen Williams',         position: 'SG', value: 21.3, active: true,  era: '2020s' },
  { id: 134, name: 'Norman Powell',          position: 'SG', value: 24.0, active: true,  era: '2020s' },
  { id: 135, name: 'Austin Reaves',          position: 'SG', value: 15.9, active: true,  era: '2020s' },
  { id: 136, name: 'Lu Dort',               position: 'SG', value: 15.4, active: true,  era: '2020s' },
  { id: 137, name: 'Coby White',             position: 'SG', value: 19.1, active: true,  era: '2020s' },
  ...
  { id: 42, name: 'Kevin Durant',            position: 'SF', value: 26.9, active: true,  era: '2010s' },
  { id: 43, name: 'Kawhi Leonard',           position: 'SF', value: 13.1, active: true,  era: '2010s' },
  { id: 44, name: 'Paul George',             position: 'SF', value: 18.1, active: true,  era: '2010s' },
  { id: 45, name: 'Jayson Tatum',            position: 'SF', value: 26.9, active: true,  era: '2020s' },
  { id: 46, name: 'Jimmy Butler',            position: 'SF', value: 20.3, active: true,  era: '2020s' },
  { id: 52, name: 'Brandon Ingram',          position: 'SF', value: 20.7, active: true,  era: '2020s' },
  { id: 103, name: 'OG Anunoby',             position: 'SF', value: 16.3, active: true,  era: '2020s' },
  { id: 104, name: 'Mikal Bridges',          position: 'SF', value: 11.3, active: true,  era: '2020s' },
  { id: 105, name: 'Paolo Banchero',         position: 'SF', value: 22.6, active: true,  era: '2020s' },
  { id: 106, name: 'Scottie Barnes',         position: 'SF', value: 19.9, active: true,  era: '2020s' },
  { id: 107, name: 'Franz Wagner',           position: 'SF', value: 23.0, active: true,  era: '2020s' },
  { id: 108, name: 'Andrew Wiggins',         position: 'SF', value: 13.7, active: true,  era: '2020s' },
  { id: 139, name: 'Miles Bridges',          position: 'SF', value: 22.1, active: true,  era: '2020s' },
  { id: 140, name: 'Khris Middleton',        position: 'SF', value: 10.4, active: true,  era: '2020s' },
  { id: 141, name: 'Herbert Jones',          position: 'SF', value: 7.5,  active: true,  era: '2020s' },
  { id: 142, name: 'Matisse Thybulle',       position: 'SF', value: 6.8,  active: true,  era: '2020s' },
  ...
  { id: 61, name: 'Anthony Davis',           position: 'PF', value: 24.7, active: true,  era: '2010s' },
  { id: 62, name: 'Jaylen Brown',            position: 'PF', value: 23.9, active: true,  era: '2020s' },
  { id: 63, name: 'Pascal Siakam',           position: 'PF', value: 22.3, active: true,  era: '2020s' },
  { id: 64, name: 'Draymond Green',          position: 'PF', value: 9.0,  active: true,  era: '2020s' },
  { id: 67, name: 'Zion Williamson',         position: 'PF', value: 24.3, active: true,  era: '2020s' },
  { id: 68, name: 'Julius Randle',           position: 'PF', value: 23.6, active: true,  era: '2020s' },
  { id: 111, name: 'Jaren Jackson Jr.',      position: 'PF', value: 22.4, active: true,  era: '2020s' },
  { id: 112, name: 'Evan Mobley',            position: 'PF', value: 18.6, active: true,  era: '2020s' },
  { id: 113, name: 'Jabari Smith Jr.',       position: 'PF', value: 14.5, active: true,  era: '2020s' },
  { id: 114, name: 'Keegan Murray',          position: 'PF', value: 16.9, active: true,  era: '2020s' },
  { id: 115, name: 'Tobias Harris',          position: 'PF', value: 12.5, active: true,  era: '2020s' },
  { id: 144, name: 'Lauri Markkanen',        position: 'PF', value: 22.2, active: true,  era: '2020s' },
  { id: 145, name: 'Bennedict Mathurin',     position: 'PF', value: 17.0, active: true,  era: '2020s' },
  { id: 146, name: 'Precious Achiuwa',       position: 'PF', value: 8.2,  active: true,  era: '2020s' },
  { id: 147, name: 'Obi Toppin',             position: 'PF', value: 10.1, active: true,  era: '2020s' },
  ...
  { id: 78, name: 'Nikola Jokic',            position: 'C',  value: 29.6, active: true,  era: '2020s' },
  { id: 79, name: 'Bam Adebayo',             position: 'C',  value: 19.4, active: true,  era: '2020s' },
  { id: 80, name: 'Karl-Anthony Towns',      position: 'C',  value: 24.3, active: true,  era: '2020s' },
  { id: 81, name: 'Rudy Gobert',             position: 'C',  value: 14.0, active: true,  era: '2020s' },
  { id: 82, name: 'Kristaps Porziņģis',      position: 'C',  value: 12.0, active: true,  era: '2020s' },
  { id: 119, name: 'Alperen Sengun',         position: 'C',  value: 22.6, active: true,  era: '2020s' },
  { id: 120, name: 'Chet Holmgren',          position: 'C',  value: 14.1, active: true,  era: '2020s' },
  { id: 121, name: 'Walker Kessler',         position: 'C',  value: 9.3,  active: true,  era: '2020s' },
  { id: 122, name: 'Brook Lopez',            position: 'C',  value: 14.2, active: true,  era: '2020s' },
  { id: 123, name: 'Domantas Sabonis',       position: 'C',  value: 19.9, active: true,  era: '2020s' },
  { id: 124, name: 'Myles Turner',           position: 'C',  value: 14.7, active: true,  era: '2020s' },
  { id: 149, name: 'Victor Wembanyama',      position: 'C',  value: 24.6, active: true,  era: '2020s' },
  { id: 150, name: 'Nikola Vucevic',         position: 'C',  value: 14.6, active: true,  era: '2020s' },
  { id: 151, name: 'Deandre Ayton',          position: 'C',  value: 17.1, active: true,  era: '2020s' },
  { id: 152, name: 'Ivica Zubac',            position: 'C',  value: 13.1, active: true,  era: '2020s' },
  { id: 153, name: 'Onyeka Okongwu',         position: 'C',  value: 11.0, active: true,  era: '2020s' },
  { id: 154, name: 'Isaiah Hartenstein',     position: 'C',  value: 7.0,  active: true,  era: '2020s' },
