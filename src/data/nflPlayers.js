...
export const NFL_PLAYERS = [
  ...
  { id: 1005, name: 'Josh Allen',          position: 'QB', value: 28,  active: true,  era: '2024' },
  ...
  { id: 1009, name: 'Kyler Murray',        position: 'QB', value: 21,  active: true,  era: '2024' },
  ...
  { id: 1013, name: 'Tua Tagovailoa',      position: 'QB', value: 19,  active: true,  era: '2024' },
  { id: 1014, name: 'Jalen Hurts',         position: 'QB', value: 18,  active: true,  era: '2024' },
  ...
  { id: 1018, name: 'Geno Smith',          position: 'QB', value: 21,  active: true,  era: '2024' },
  ...
  { id: 1024, name: 'Bryce Young',         position: 'QB', value: 15,  active: true,  era: '2024' },
  ...
  { id: 1109, name: 'Drake London',        position: 'WR', value: 1271, active: true,  era: '2024' },
  { id: 1106, name: 'Amon-Ra St. Brown',   position: 'WR', value: 1263, active: true,  era: '2024' },
  { id: 2103, name: 'Jerry Jeudy',         position: 'WR', value: 1229, active: true,  era: '2024' },
  { id: 1105, name: 'Malik Nabers',        position: 'WR', value: 1204, active: true,  era: '2024' },
  { id: 1101, name: 'CeeDee Lamb',         position: 'WR', value: 1194, active: true,  era: '2024' },
  { id: 1111, name: 'Ladd McConkey',       position: 'WR', value: 1149, active: true,  era: '2024' },
  { id: 2104, name: 'Jaxon Smith-Njigba',  position: 'WR', value: 1130, active: true,  era: '2024' },
  { id: 1108, name: 'Garrett Wilson',      position: 'WR', value: 1104, active: true,  era: '2024' },
  { id: 2105, name: 'Terry McLaurin',      position: 'WR', value: 1096, active: true,  era: '2024' },
  { id: 2106, name: 'Courtland Sutton',    position: 'WR', value: 1081, active: true,  era: '2024' },
  { id: 1110, name: 'A.J. Brown',          position: 'WR', value: 1079, active: true,  era: '2024' },
  { id: 1120, name: 'Davante Adams',       position: 'WR', value: 1063, active: true,  era: '2024' },
  { id: 2107, name: 'Zay Flowers',         position: 'WR', value: 1059, active: true,  era: '2024' },
  { id: 2108, name: 'Jakobi Meyers',       position: 'WR', value: 1027, active: true,  era: '2024' },
  { id: 2109, name: 'Calvin Ridley',       position: 'WR', value: 1017, active: true,  era: '2024' },
  { id: 2110, name: 'Nico Collins',        position: 'WR', value: 1006, active: true,  era: '2024' },
  { id: 1114, name: 'Mike Evans',          position: 'WR', value: 1004, active: true,  era: '2024' },
  { id: 2111, name: 'Jameson Williams',    position: 'WR', value: 1001, active: true,  era: '2024' },
  { id: 1118, name: 'D.K. Metcalf',        position: 'WR', value: 992,  active: true,  era: '2024' },
  { id: 2112, name: 'Darnell Mooney',      position: 'WR', value: 992,  active: true,  era: '2024' },
  { id: 1124, name: 'Puka Nacua',          position: 'WR', value: 990,  active: true,  era: '2024' },
  { id: 2113, name: 'D.J. Moore',          position: 'WR', value: 966,  active: true,  era: '2024' },
  { id: 1107, name: 'Tyreek Hill',         position: 'WR', value: 959,  active: true,  era: '2024' },
  { id: 1116, name: 'Tee Higgins',         position: 'WR', value: 911,  active: true,  era: '2024' },
  { id: 2114, name: 'George Pickens',      position: 'WR', value: 900,  active: true,  era: '2024' },
  { id: 2101, name: 'Marvin Harrison Jr.', position: 'WR', value: 885,  active: true,  era: '2024' },
  { id: 2115, name: 'Jordan Addison',      position: 'WR', value: 875,  active: true,  era: '2024' },
  { id: 2116, name: 'Jayden Reed',         position: 'WR', value: 857,  active: true,  era: '2024' },
  { id: 1117, name: 'DeVonta Smith',       position: 'WR', value: 833,  active: true,  era: '2024' },
  { id: 2117, name: 'Alec Pierce',         position: 'WR', value: 824,  active: true,  era: '2024' },
  { id: 2118, name: 'Khalil Shakir',       position: 'WR', value: 821,  active: true,  era: '2024' },
  { id: 1113, name: 'Jaylen Waddle',       position: 'WR', value: 744,  active: true,  era: '2024' },
  { id: 1121, name: 'Keenan Allen',        position: 'WR', value: 744,  active: true,  era: '2024' },
  { id: 1119, name: 'Rome Odunze',         position: 'WR', value: 734,  active: true,  era: '2024' },
  { id: 1115, name: 'Cooper Kupp',         position: 'WR', value: 710,  active: true,  era: '2024' },
  { id: 1122, name: 'DeAndre Hopkins',     position: 'WR', value: 610,  active: true,  era: '2024' },
  { id: 1123, name: 'Tyler Lockett',       position: 'WR', value: 600,  active: true,  era: '2024' },
  { id: 2102, name: 'Xavier Worthy',       position: 'WR', value: 638,  active: true,  era: '2024' },
  { id: 1112, name: 'Brandon Aiyuk',       position: 'WR', value: 374,  active: true,  era: '2024' },
  // Historical (career-best single season)
  ...
  { id: 1213, name: 'James Cook',          position: 'RB', value: 16,  active: true,  era: '2024' },
  { id: 1202, name: 'Jahmyr Gibbs',        position: 'RB', value: 16,  active: true,  era: '2024' },
  { id: 1214, name: 'Josh Jacobs',         position: 'RB', value: 15,  active: true,  era: '2024' },
  { id: 1205, name: 'Kyren Williams',      position: 'RB', value: 14,  active: true,  era: '2024' },
  { id: 1207, name: 'Bijan Robinson',      position: 'RB', value: 14,  active: true,  era: '2024' },
  { id: 1203, name: 'Saquon Barkley',      position: 'RB', value: 13,  active: true,  era: '2024' },
  { id: 2201, name: 'David Montgomery',    position: 'RB', value: 12,  active: true,  era: '2024' },
  { id: 1204, name: 'Joe Mixon',           position: 'RB', value: 11,  active: true,  era: '2024' },
  { id: 1208, name: 'Jonathan Taylor',     position: 'RB', value: 11,  active: true,  era: '2024' },
  { id: 2203, name: 'Chuba Hubbard',       position: 'RB', value: 10,  active: true,  era: '2024' },
  { id: 2207, name: 'J.K. Dobbins',        position: 'RB', value: 9,   active: true,  era: '2024' },
  { id: 2205, name: 'James Conner',        position: 'RB', value: 8,   active: true,  era: '2024' },
  { id: 1215, name: 'Brian Robinson Jr.',  position: 'RB', value: 8,   active: true,  era: '2024' },
  { id: 2208, name: 'Zach Charbonnet',     position: 'RB', value: 8,   active: true,  era: '2024' },
  { id: 2209, name: 'Bucky Irving',        position: 'RB', value: 8,   active: true,  era: '2024' },
  { id: 2210, name: 'Kareem Hunt',         position: 'RB', value: 7,   active: true,  era: '2024' },
  { id: 2211, name: 'Rhamondre Stevenson', position: 'RB', value: 7,   active: true,  era: '2024' },
  { id: 2212, name: 'Kenneth Walker III',  position: 'RB', value: 7,   active: true,  era: '2024' },
  { id: 2213, name: 'Tank Bigsby',         position: 'RB', value: 7,   active: true,  era: '2024' },
  { id: 2214, name: 'Chase Brown',         position: 'RB', value: 7,   active: true,  era: '2024' },
  { id: 1219, name: "D'Andre Swift",       position: 'RB', value: 6,   active: true,  era: '2024' },
  { id: 2202, name: 'Najee Harris',        position: 'RB', value: 6,   active: true,  era: '2024' },
  { id: 1209, name: 'Alvin Kamara',        position: 'RB', value: 6,   active: true,  era: '2024' },
  { id: 1206, name: "De'Von Achane",       position: 'RB', value: 6,   active: true,  era: '2024' },
  { id: 1216, name: 'Aaron Jones',         position: 'RB', value: 5,   active: true,  era: '2024' },
  { id: 1217, name: 'Tony Pollard',        position: 'RB', value: 5,   active: true,  era: '2024' },
  { id: 1211, name: 'Breece Hall',         position: 'RB', value: 5,   active: true,  era: '2024' },
  { id: 2206, name: 'Javonte Williams',    position: 'RB', value: 4,   active: true,  era: '2024' },
  { id: 2204, name: 'Tyjae Spears',        position: 'RB', value: 4,   active: true,  era: '2024' },
  { id: 1220, name: 'Rachaad White',       position: 'RB', value: 3,   active: true,  era: '2024' },
  { id: 1218, name: 'Travis Etienne Jr.',  position: 'RB', value: 2,   active: true,  era: '2024' },
  { id: 1210, name: 'Isiah Pacheco',       position: 'RB', value: 1,   active: true,  era: '2024' },
  { id: 1212, name: 'Christian McCaffrey', position: 'RB', value: 0,   active: true,  era: '2024' },
  // Historical (career-best single season)
  ...
  // Active (2024 NFL season, source: nflverse)
  { id: 1301, name: 'Marlon Humphrey',     position: 'CB', value: 6,   active: true,  era: '2024' },
  { id: 1302, name: 'Byron Murphy II',     position: 'CB', value: 6,   active: true,  era: '2024' },
  { id: 1303, name: 'Derek Stingley Jr.',  position: 'CB', value: 5,   active: true,  era: '2024' },
  { id: 1304, name: 'Donte Jackson',       position: 'CB', value: 5,   active: true,  era: '2024' },
  { id: 1305, name: 'Patrick Surtain II',  position: 'CB', value: 4,   active: true,  era: '2024' },
  { id: 1306, name: 'Tarheeb Still',       position: 'CB', value: 4,   active: true,  era: '2024' },
  { id: 1307, name: 'Beanie Bishop Jr.',   position: 'CB', value: 4,   active: true,  era: '2024' },
  { id: 1308, name: 'Cam Taylor-Britt',    position: 'CB', value: 3,   active: true,  era: '2024' },
  { id: 1309, name: 'Jack Jones',          position: 'CB', value: 3,   active: true,  era: '2024' },
  { id: 1310, name: 'Tariq Woolen',        position: 'CB', value: 3,   active: true,  era: '2024' },
  { id: 1311, name: 'Paulson Adebo',       position: 'CB', value: 3,   active: true,  era: '2024' },
  { id: 1312, name: 'Kamari Lassiter',     position: 'CB', value: 3,   active: true,  era: '2024' },
  { id: 1313, name: 'Kenny Moore II',      position: 'CB', value: 3,   active: true,  era: '2024' },
  { id: 1314, name: 'Elijah Molden',       position: 'CB', value: 3,   active: true,  era: '2024' },
  { id: 1315, name: 'Coby Bryant',         position: 'CB', value: 3,   active: true,  era: '2024' },
  { id: 2301, name: 'Sean Murphy-Bunting', position: 'CB', value: 3,   active: true,  era: '2024' },
  { id: 2302, name: 'Denzel Ward',         position: 'CB', value: 2,   active: true,  era: '2024' },
  { id: 2303, name: 'Zyon McCollum',       position: 'CB', value: 2,   active: true,  era: '2024' },
  { id: 2304, name: 'Mike Sainristil',     position: 'CB', value: 2,   active: true,  era: '2024' },
  { id: 2305, name: 'Trent McDuffie',      position: 'CB', value: 2,   active: true,  era: '2024' },
  { id: 2306, name: 'Tyrique Stevenson',   position: 'CB', value: 2,   active: true,  era: '2024' },
  { id: 2307, name: 'Carlton Davis III',   position: 'CB', value: 2,   active: true,  era: '2024' },
  { id: 2308, name: 'Trevon Diggs',        position: 'CB', value: 2,   active: true,  era: '2024' },
  { id: 2309, name: 'Christian Gonzalez',  position: 'CB', value: 2,   active: true,  era: '2024' },
  { id: 2310, name: 'Jaire Alexander',     position: 'CB', value: 2,   active: true,  era: '2024' },
  { id: 2311, name: 'A.J. Terrell',        position: 'CB', value: 2,   active: true,  era: '2024' },
  { id: 2312, name: 'Jaycee Horn',         position: 'CB', value: 1,   active: true,  era: '2024' },
  { id: 2313, name: 'Nate Wiggins',        position: 'CB', value: 1,   active: true,  era: '2024' },
  { id: 2314, name: 'Stephon Gilmore',     position: 'CB', value: 1,   active: true,  era: '2024' },
  { id: 2315, name: 'Sauce Gardner',       position: 'CB', value: 1,   active: true,  era: '2024' },
  // Historical (career-best single season)
  ...
  // Active (2024 NFL season, source: nflverse)
  { id: 1401, name: 'Budda Baker',         position: 'S',  value: 95,  active: true,  era: '2024' },
  { id: 1402, name: 'Nick Cross',          position: 'S',  value: 86,  active: true,  era: '2024' },
  { id: 1410, name: 'Kevin Byard',         position: 'S',  value: 80,  active: true,  era: '2024' },
  { id: 2401, name: 'Brandon Jones',       position: 'S',  value: 79,  active: true,  era: '2024' },
  { id: 2402, name: 'Brian Branch',        position: 'S',  value: 79,  active: true,  era: '2024' },
  { id: 1406, name: 'Kyle Hamilton',       position: 'S',  value: 77,  active: true,  era: '2024' },
  { id: 2403, name: 'Julian Love',         position: 'S',  value: 76,  active: true,  era: '2024' },
  { id: 2404, name: 'DeShon Elliott',      position: 'S',  value: 73,  active: true,  era: '2024' },
  { id: 2405, name: 'Quentin Lake',        position: 'S',  value: 73,  active: true,  era: '2024' },
  { id: 2406, name: 'Xavier Woods',        position: 'S',  value: 72,  active: true,  era: '2024' },
  { id: 2407, name: 'Grant Delpit',        position: 'S',  value: 67,  active: true,  era: '2024' },
  { id: 2408, name: 'Jeremy Chinn',        position: 'S',  value: 67,  active: true,  era: '2024' },
  { id: 2409, name: 'Trevon Moehrig',      position: 'S',  value: 64,  active: true,  era: '2024' },
  { id: 2410, name: 'Josh Metellus',       position: 'S',  value: 63,  active: true,  era: '2024' },
  { id: 1404, name: 'Jessie Bates III',    position: 'S',  value: 62,  active: true,  era: '2024' },
  { id: 1408, name: 'Minkah Fitzpatrick',  position: 'S',  value: 62,  active: true,  era: '2024' },
  { id: 2411, name: 'Julian Blackmon',     position: 'S',  value: 62,  active: true,  era: '2024' },
  { id: 2412, name: 'Jalen Thompson',      position: 'S',  value: 61,  active: true,  era: '2024' },
  { id: 2413, name: 'Damar Hamlin',        position: 'S',  value: 61,  active: true,  era: '2024' },
  { id: 1407, name: 'Derwin James Jr.',    position: 'S',  value: 60,  active: true,  era: '2024' },
  { id: 2414, name: 'Xavier McKinney',     position: 'S',  value: 59,  active: true,  era: '2024' },
  { id: 1405, name: 'Harrison Smith',      position: 'S',  value: 56,  active: true,  era: '2024' },
  { id: 2415, name: 'Kyle Dugger',         position: 'S',  value: 54,  active: true,  era: '2024' },
  { id: 2416, name: 'Camryn Bynum',        position: 'S',  value: 54,  active: true,  era: '2024' },
  { id: 2417, name: 'Bryan Cook',          position: 'S',  value: 54,  active: true,  era: '2024' },
  { id: 2418, name: 'Reed Blankenship',    position: 'S',  value: 52,  active: true,  era: '2024' },
  { id: 1409, name: 'Jordan Poyer',        position: 'S',  value: 51,  active: true,  era: '2024' },
  // Historical (career-best single season)
  ...
  { id: 2501, name: 'Nik Bonitto',         position: 'EDGE', value: 13.5, active: true,  era: '2024' },
  { id: 1504, name: 'Micah Parsons',       position: 'EDGE', value: 12.0, active: true,  era: '2024' },
  { id: 1505, name: 'Jonathan Greenard',   position: 'EDGE', value: 12.0, active: true,  era: '2024' },
  { id: 1506, name: 'Danielle Hunter',     position: 'EDGE', value: 12.0, active: true,  era: '2024' },
  { id: 1501, name: 'T.J. Watt',           position: 'EDGE', value: 11.5, active: true,  era: '2024' },
  { id: 2502, name: 'Andrew Van Ginkel',   position: 'EDGE', value: 11.5, active: true,  era: '2024' },
  { id: 2503, name: 'Will Anderson Jr.',   position: 'EDGE', value: 11.0, active: true,  era: '2024' },
  { id: 2504, name: 'Dante Fowler Jr.',    position: 'EDGE', value: 10.5, active: true,  era: '2024' },
  { id: 2505, name: 'Jonathon Cooper',     position: 'EDGE', value: 10.5, active: true,  era: '2024' },
  { id: 2506, name: 'Travon Walker',       position: 'EDGE', value: 10.5, active: true,  era: '2024' },
  { id: 2507, name: 'Will McDonald IV',    position: 'EDGE', value: 10.5, active: true,  era: '2024' },
  { id: 2508, name: 'Odafe Oweh',          position: 'EDGE', value: 10.0, active: true,  era: '2024' },
  { id: 2509, name: 'Harold Landry III',   position: 'EDGE', value: 9.0,  active: true,  era: '2024' },
  { id: 1515, name: 'Nick Bosa',           position: 'EDGE', value: 9.0,  active: true,  era: '2024' },
  { id: 2510, name: 'Leonard Floyd',       position: 'EDGE', value: 8.5,  active: true,  era: '2024' },
  { id: 1510, name: 'Brian Burns',         position: 'EDGE', value: 8.5,  active: true,  era: '2024' },
  { id: 2511, name: 'Tuli Tuipulotu',      position: 'EDGE', value: 8.5,  active: true,  era: '2024' },
  { id: 1511, name: 'Josh Hines-Allen',    position: 'EDGE', value: 8.0,  active: true,  era: '2024' },
  { id: 2512, name: 'Kwity Paye',          position: 'EDGE', value: 8.0,  active: true,  era: '2024' },
  { id: 2513, name: 'Gregory Rousseau',    position: 'EDGE', value: 8.0,  active: true,  era: '2024' },
  { id: 2514, name: 'George Karlaftis',    position: 'EDGE', value: 8.0,  active: true,  era: '2024' },
  { id: 2515, name: 'Derick Hall',         position: 'EDGE', value: 8.0,  active: true,  era: '2024' },
  { id: 1508, name: 'Maxx Crosby',         position: 'EDGE', value: 7.5,  active: true,  era: '2024' },
  { id: 2516, name: 'Rashan Gary',         position: 'EDGE', value: 7.5,  active: true,  era: '2024' },
  ...
  { id: 1507, name: 'Khalil Mack',         position: 'EDGE', value: 6.0,  active: true,  era: '2024' },
  { id: 1519, name: 'Von Miller',          position: 'EDGE', value: 6.0,  active: true,  era: '2024' },
  { id: 1509, name: 'Matthew Judon',       position: 'EDGE', value: 5.5,  active: true,  era: '2024' },
  { id: 1517, name: 'Laiatu Latu',         position: 'EDGE', value: 4.0,  active: true,  era: '2024' },
  { id: 1520, name: 'Cameron Jordan',      position: 'EDGE', value: 4.0,  active: true,  era: '2024' },
  { id: 1516, name: "Za'Darius Smith",     position: 'EDGE', value: 4.0,  active: true,  era: '2024' },
  { id: 1513, name: 'Lukas Van Ness',      position: 'EDGE', value: 3.0,  active: true,  era: '2024' },
  { id: 1514, name: 'Dallas Turner',       position: 'EDGE', value: 3.0,  active: true,  era: '2024' },
  // Historical (career-best single season)
